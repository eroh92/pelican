...
_DEFAULT_CONFIG = {'PATH': '.',
                   ...
                   'INDEX_PAGINATED_URL': 'index{page}.html',
                   'INDEX_PAGINATED_SAVE_AS': 'index{page}.html',
                   'INDEX_ASYNC_TEMPLATE' : 'index_async',
                   'CATEGORY_URL': 'category/{slug}.html',
                   'CATEGORY_PAGINATED_URL': 'category/{slug}-{page}.html',
                   'CATEGORY_SAVE_AS': 'category/{slug}.html',
                   'CATEGORY_PAGINATED_SAVE_AS': 'category/{slug}-{page}.html',
                   'CATEGORY_ASYNC_TEMPLATE': 'category_async',
                   'TAG_URL': 'tag/{slug}.html',
                   'TAG_PAGINATED_URL': 'tag/{slug}-{page}.html',
                   'TAG_SAVE_AS': 'tag/{slug}.html',
                   'TAG_PAGINATED_SAVE_AS': 'tag/{slug}-{page}.html',
                   'TAG_ASYNC_TEMPLATE': 'tag_async',
                   'AUTHOR_URL': 'author/{slug}.html',
                   'AUTHOR_PAGINATED_URL': 'author/{slug}-{page}.html',
                   'AUTHOR_SAVE_AS': 'author/{slug}.html',
                   'AUTHOR_PAGINATED_SAVE_AS': 'author/{slug}-{page}.html',
                   'AUTHOR_ASYNC_TEMPLATE': 'author_async',
                   'RELATIVE_URLS': True,
                   'DEFAULT_LANG': 'en',
                   'TAG_CLOUD_STEPS': 4,
                   ...
                   'PAGINATED_DIRECT_TEMPLATES_SAVE_AS': ('index.html', ),
                   'PELICAN_CLASS': 'pelican.Pelican',
                   'DEFAULT_DATE_FORMAT': '%a %d %B %Y',
                   'DATE_FORMATS': {},
                   'JINJA_EXTENSIONS': [],
                   'LOCALE': '',  # default to user locale
                   'GENERATE_ASYNC_FILES': False,
